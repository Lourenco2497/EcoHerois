...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function instanciarLampadas() {
        ...
        const layoutCoords = isMobilePortrait ? [
            { x: 0.18, y: 0.10, size: 54 }, // Teto canto esquerdo
            { x: 0.82, y: 0.10, size: 54 }, // Teto canto direito
            { x: 0.50, y: 0.18, size: 62 }, // Lustre central suspenso
            { x: 0.22, y: 0.28, size: 54 }, // Aplique parede esquerda
            { x: 0.78, y: 0.26, size: 54 }, // Aplique parede direita
            { x: 0.16, y: 0.42, size: 56 }, // Candeeiro secretária esquerda
            { x: 0.52, y: 0.44, size: 56 }, // Luz ambiente centro
            { x: 0.82, y: 0.40, size: 56 }, // Abajur estante direita
            { x: 0.28, y: 0.60, size: 58 }, // Luz mesa de apoio
            { x: 0.74, y: 0.58, size: 60 }  // Candeeiro de pé sofá
        ] : [
            { x: 0.12, y: 0.16, size: 74 }, // Teto canto esquerdo
            { x: 0.32, y: 0.14, size: 78 }, // Candeeiro de teto esquerdo
            { x: 0.50, y: 0.25, size: 84 }, // Lustre central suspenso na sala
            { x: 0.72, y: 0.14, size: 78 }, // Candeeiro suspenso direito
            { x: 0.88, y: 0.16, size: 72 }, // Aplique teto lateral
